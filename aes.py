...
class AES128:
    ...
    def __init__(self):
        ...
        # Pre-calculated Galois multiplications
        self.galois_mul2 = [0x00, 0x02, 0x04, 0x06, 0x08, 0x0a, 0x0c, 0x0e, 0x10, 0x12, 0x14, 0x16, 0x18, 0x1a, 0x1c,
                            ...
                            0xe5]
        self.galois_mul3 = [0x00, 0x03, 0x06, 0x05, 0x0c, 0x0f, 0x0a, 0x09, 0x18, 0x1b, 0x1e, 0x1d, 0x14, 0x17, 0x12,
                            ...
                            0x1a]
        self.galois_mul9 = [0x00, 0x09, 0x12, 0x1b, 0x24, 0x2d, 0x36, 0x3f, 0x48, 0x41, 0x5a, 0x53, 0x6c, 0x65, 0x7e,
                            ...
                            0x46]
        self.galois_mul11 = [0x00, 0x0b, 0x16, 0x1d, 0x2c, 0x27, 0x3a, 0x31, 0x58, 0x53, 0x4e, 0x45, 0x74, 0x7f, 0x62,
                             ...
                             0xa3]
        self.galois_mul13 = [0x00, 0x0d, 0x1a, 0x17, 0x34, 0x39, 0x2e, 0x23, 0x68, 0x65, 0x72, 0x7f, 0x5c, 0x51, 0x46,
                             ...
                             0x97]
        self.galois_mul14 = [0x00, 0x0e, 0x1c, 0x12, 0x38, 0x36, 0x24, 0x2a, 0x70, 0x7e, 0x6c, 0x62, 0x48, 0x46, 0x54,
    ...
    def galois_lookup(self, a, b):
        if a == 1:
            return b
        elif a == 2:
            return self.galois_mul2[b]
        elif a == 3:
            return self.galois_mul3[b]
        elif a == 9:
            return self.galois_mul9[b]
        elif a == 11:
            return self.galois_mul11[b]
        elif a == 13:
            return self.galois_mul13[b]
        elif a == 14:
            return self.galois_mul14[b]
    ...
    def matrix_mul(self, matrix, vector):
        ...
        for row in range(4):
            res = 0
            for cell in range(4):
                # galois = self.galois(matrix[row][cell], vector[cell])
                galois = self.galois_lookup(matrix[row][cell], vector[cell])
                res = res ^ galois
            result.append(res)
        return result
